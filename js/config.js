...
(function (global) {
  ...
  const CONFIG = {
     ...
     * ------------------------------------------------------- */
    LEVELS: [
      { key: 'L1',    label: 'LEVEL 1',    remainingMax: 60, remainingMin: 45, choiceCount: 7,  questionSec: 8.0 },
      { key: 'L2',    label: 'LEVEL 2',    remainingMax: 45, remainingMin: 25, choiceCount: 10, questionSec: 6.5 },
      { key: 'L3',    label: 'LEVEL 3',    remainingMax: 25, remainingMin: 10, choiceCount: 13, questionSec: 5.5 },
      { key: 'FINAL', label: 'FINAL RUSH', remainingMax: 10, remainingMin: 0,  choiceCount: 16, questionSec: 4.5 },
    ],
    ...
    SCORE: {
      ...
      wrong: -100,              // 오답 후보 단어 완성
      missedAnswer: -150,       // 정답 단어를 놓침(바닥까지 떨어짐)
